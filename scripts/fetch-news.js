...
const FEEDS = [
  ...
  { url: 'https://www.agenceecofin.com/telecom/feed', source: 'Agence Ecofin', category: 'smartphones' },
  { url: 'https://www.wearetech.africa/feed', source: 'We Are Tech Africa', category: 'culture' },
];
...
async function main() {
  ...
  // Résumé IA en option, avec repli automatique sur l'extrait RSS
